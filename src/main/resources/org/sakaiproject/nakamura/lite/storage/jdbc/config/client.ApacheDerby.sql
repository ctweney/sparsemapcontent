...
delete-string-row.n.act = delete from act_css where rid = ?
...
select-string-row.n.act = select cid, v from act_css where rid = ?
...
insert-string-column.n.act = insert into act_css ( v, rid, cid) values ( ?, ?, ?)
...
update-string-column.n.act = update act_css set v = ?  where rid = ? and cid = ?
...
remove-string-column.n.act = delete from act_css where rid = ? and cid = ?
...
find.n.act = select TR.rid, TR.cid, TR.v from (select a.rid, a.cid, a.v, ROW_NUMBER() OVER () AS R from act_css a {0} where {1} 1 = 1 {2}) as TR where TR.R > {4,number,#} and TR.R <= {3,number,#}+{4,number,#};, act_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1}
...
block-select-row.n.act = select b from act_css_b where rid = ?
block-delete-row.n.act = delete from act_css_b where rid = ?
block-insert-row.n.act = insert into act_css_b (rid,b) values (?, ?)
block-update-row.n.act = update act_css_b set b = ? where rid = ?
list-all.n.act = select rid, b from act_css_b
list-all-count.n.act = select count(*) from act_css_b
...
block-find.n.act = select TR.rid from (select s.rid, ROW_NUMBER() OVER () AS R from (select distinct a.rid  {5} from act_css a {0} where {1} 1 = 1 {2}) as s) as TR where TR.R > {4,number,#} and TR.R <= {3,number,#}+{4,number,#};, act_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1};, {0}.v
...
listchildren.n.act = select distinct a.rid  {5} from act_css a {0} where {1} 1 = 1 {2};, act_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1};, {0}.v
...
countestimate.n.act = select count(*) from (select distinct a.rid  {5} from act_css a {0} where {1} 1 = 1 {2}) as tocount;, act_css {0} ; {0}.cid = ? and {0}.v = ? and {0}.rid = a.rid ; {0}.cid = ? and {0}.rid = a.rid ; order by {0}.v {1};, {0}.v
...
exists-widestring-row.n.act = select rid from act_css_w where rid = ?
...
delete-widestring-row.n.act = delete from act_css_w where rid = ?
...
update-widestring-row.n.act = update act_css_w set {0} where rid = ?; {0} = ?
...
insert-widestring-row.n.act = insert into act_css_w ( rid {0} ) values ( ? {1} )
...
wide-block-find.n.act = select TR.rid from (select s.rid, ROW_NUMBER() OVER () AS R from (select a.rid from act_css_w a where {0} {1} ) as s) as TR where TR.R > {3,number,#} and TR.R <= {2,number,#}+{3,number,#};a.{0} = ?;a.rid in ( select {0}.rid from act_css {0} where {1} );{0}.cid = ? and {0}.v = ?;sort by {0};{0} {1}
...
wide-listchildren.n.act = select a.rid from act_css_w a where {0} {1} ;a.{0} = ?;a.rid in ( select {0}.rid from act_css {0} where {1} );{0}.cid = ? and {0}.v = ?;sort by {0};{0} {1}
...
wide-countestimate.n.act = select count(*) from act_css_w a where {0} {1} ;a.{0} = ?;a.rid in ( select {0}.rid from act_css {0} where {1} );{0}.cid = ? and {0}.v = ?;sort by {0};{0} {1}
